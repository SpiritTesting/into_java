...
class Kontaktbuch {
    ...
    Ausgabe removeAdresse(String id) {
        ...
        //System.console().format(format, "Übergabe", "id ="+ id);
        System.out.println("Übergabe id= " + id);
        ...
        while (true) {
            ...
            try {
                ...
                switch (command.command) {
                    ...
                    case "remadd":
                        if (command.parameters.length != 1) {
                            ausgaben.add(new Ausgabe("Fehler", "Bitte geben Sie die ID der zu l�schenden Adresse ein. Denken Sie an das HashTag!"));
                            break;
                        }
