...
class Adresse {
    ...
    private final String id; // Das Schl�sselwort final sorgt daf�r, dass das Feld ausschlie�lich in seiner eigenen Deklaration und im Konstruktor �berschrieben werden kann. Dementsprechend fehlt auch der Setter.
    ...
    Adresse(String id) {
        // wir wollen, dass ID niemals auf <null> gesetzt wird. Falls null �bergeben wird, wirft die Klasse einen Fehler.
    ...
    public String toString() {
        return "a.Adresse [id=" + id + ", strasse=" + strasse + ", hausnummer=" + hausnummer + ", postleitzahl="
