...
class Adresse {
	...
	private final String id; // Das Schl�sselwort final sorgt daf�r, dass das Feld ausschlie�lich in seiner eigenen
	// Deklaration und im Konstruktor �berschrieben werden kann. Dementsprechend fehlt auch der Setter.
